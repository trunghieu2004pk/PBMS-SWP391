...
const steps = [
  {
    ...
    desc: "Tạo tài khoản khách hàng miễn phí chỉ trong một phút.",
  },
  {
    n: "02",
    title: "Tìm & đặt chỗ",
    desc: "Chọn bãi đỗ, xem chỗ trống và giữ chỗ theo nhu cầu.",
  },
  {
    n: "03",
    title: "Gửi xe & thanh toán",
    desc: "Vào/ra bằng biển số, hệ thống tính phí tự động.",
  },
];
...
export default function HomePage() {
  ...
  const primaryTo = isAuthenticated
    ? getHomePathForRole(getRoleName(user))
    : "/register";
  ...
  return (
    <>
      ...
      <section id="top" className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-4 py-20 text-center md:py-28">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg text-slate-500">
            Giải pháp quản lý bãi đỗ xe thông minh cho cuộc sống hiện đại — tiết
            kiệm thời gian, tối ưu chi phí và vận hành minh bạch.
          </p>
          ...
          <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
            <Link to={primaryTo}>
              <Button
                size="lg"
                className="brand-gradient border-0 px-7 shadow-(--shadow-soft)"
              >
                {primaryLabel}
              </Button>
            </Link>
          ...
          <div className="mx-auto mt-16 grid max-w-4xl grid-cols-2 gap-4 sm:grid-cols-4">
            {stats.map((s) => (
              <div
                key={s.label}
                className="rounded-2xl border border-slate-200 bg-surface-raised p-5 shadow-(--shadow-card)"
              >
                <div className="brand-text-gradient text-3xl font-extrabold">
                  {s.value}
                </div>
      ...
      <section id="features" className="mx-auto max-w-6xl px-4 py-20">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold tracking-tight text-slate-900">
            Mọi thứ bạn cần để vận hành bãi đỗ
          </h2>
          <p className="mt-3 text-slate-500">
            Từ tìm chỗ, đặt chỗ đến thanh toán và báo cáo — tất cả trong một hệ
            thống.
          </p>
        </div>
      ...
      <section id="how" className="bg-surface-raised">
        <div className="mx-auto max-w-6xl px-4 py-20">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-slate-500">
              Đơn giản từ lúc đăng ký đến khi gửi xe.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {steps.map((s) => (
              <div
                key={s.n}
                className="relative rounded-2xl border border-slate-200 bg-surface p-7"
              >
                <span className="brand-text-gradient text-4xl font-extrabold">
                  {s.n}
                </span>
      ...
      <section className="mx-auto max-w-6xl px-4 py-20">
        <div className="brand-gradient relative overflow-hidden rounded-3xl px-6 py-14 text-center shadow-(--shadow-soft)">
          ...
          <h2 className="relative text-3xl font-bold text-white md:text-4xl">
            Sẵn sàng đỗ xe thông minh hơn?
          </h2>
          <p className="relative mx-auto mt-3 max-w-xl text-white/85">
            Tạo tài khoản khách hàng miễn phí và trải nghiệm đặt chỗ ngay hôm
            nay.
          </p>
          <div className="relative mt-8 flex flex-wrap justify-center gap-3">
            <Link to={primaryTo}>
              <Button
                size="lg"
                variant="white"
                className="px-7 shadow-(--shadow-soft)"
              >
                {primaryLabel}
              </Button>
            </Link>
